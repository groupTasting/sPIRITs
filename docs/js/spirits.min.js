...
var vueGinCheck = new Vue({
  ...
  checkStore: function () {
       var storeUrl = 'https://www.jsonstore.io/c6b371c6f7d035fad6c5c3a1c99b7403dfb42102f6be5e97ed8eb4695291ec66/gin/0
';
       axios
         .get(storeUrl)
         .then(response => { 
...
var vueGin = new Vue({
  ...
  methods: { 
     ...
     checkTaste: function (probe, uid) {
       ...
       var koboUrl = 'https://kf.kobotoolbox.org/api/v2/assets/akX5hMZpLEEcQa77RCNabg/data.json?query='+query;
       axios
