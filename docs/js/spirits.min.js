...
var vueGin = new Vue({
  ...
  computed: {
     ...
     nextGin: function () { return (this.posGin() && ((this.posGin() + 1) < this.ginlist.length)) ? this.ginlist[this.posGin() + 1] : null; },
     prevGin: function () { return (this.posGin() && ((this.posGin() - 1) >= 0)) ? this.ginlist[this.posGin() - 1] : null; },
  },
  mounted () { 
