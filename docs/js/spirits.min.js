var radarParameter = ["wacholder", "kraeuter", "zitrus", "frucht", "blume", "wuerze", "erde", "suesse", "schaerfe"];
...
function drawChart(ginData, elem, type) {
  ...
  var myChart = new Chart(elem, {
    ...
    data: {labels: radarParameter, 
           datasets: [{data: maxData, backgroundColor: utils.transparentize(presets.orange), borderColor: presets.orange},
                      {data: ownData, backgroundColor: utils.transparentize(presets.green), borderColor: presets.green },
                      {data: avgData, backgroundColor: utils.transparentize(presets.red), borderColor: presets.red },
                      {data: minData, backgroundColor: utils.transparentize(presets.orange), borderColor: presets.orange },
                     ]
          },  
    options: options
  })
