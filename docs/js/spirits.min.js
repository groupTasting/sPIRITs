...
// https://jsonbox.io/   https://github.com/vasanthv/jsonbox#readme
  ...
  methods: { 
     ...
     setTaste: function (json) {
       this.allTastes = json;
         ...
         this.ginData = {"ts": Date.now(), "size": json.length ,"data": json, "statistic": result};  
         var dbUrl = getGinDb()+"gin"+this.ginId;
         axios
           .post(dbUrl, this.ginData)
     ...
     inqTaste: function () {
       ...
       axios
         ...
         .then(response => { 
            ...
            if ('contents' in data) { data = data.contents; }
	    this.setTaste(data);	
       });
     },
  },
  ...
  mounted () {
	...
	var tmpGinId = '1'; 
	  ...
	  tmpGinId = id;  
        ...
        this.updTaste();	
        this.updInt = setInterval(this.updTaste, 35000); //ms : 35s
