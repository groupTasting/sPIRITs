...
function drawChart(ginData, elem, type) {
  ...
  var myChart = new Chart(elem, {
    ...
    data: {labels: radarParameter, 
           datasets: [{data: maxData, backgroundColor: transparentize(presets.orange), borderColor: presets.orange},
                      {data: ownData, backgroundColor: transparentize(presets.green), borderColor: presets.green },
                      {data: avgData, backgroundColor: transparentize(presets.red), borderColor: presets.red },
                      {data: minData, backgroundColor: transparentize(presets.orange), borderColor: presets.orange },
                     ]
          },  
    options: options
  })
