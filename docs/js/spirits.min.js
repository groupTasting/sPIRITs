...
var vueGin = new Vue({
  ...
  computed: {
     ...
     nextGin: function () { return (this.posGin && this.ginList && ((this.posGin + 1) < this.ginList.length)) ? this.ginList[this.posGin + 1] : null; },
     prevGin: function () { return (this.posGin && this.ginList && ((this.posGin - 1) >= 0)) ? this.ginList[this.posGin - 1] : null; },
  },
  mounted () { 
