...
function checkUrlSubString(str) {
  return location.href.indexOf(str);
}
...
var vueGin = new Vue({
  ...
  computed: {
	...
	'price_color=333333&title_color=0066c0&bg_color=ffffff' ; },
     amzId: function () {return ginInfo.asin ? ginInfo : 'B00VQRR4E6'; },
     amzLink: function () {return ginInfo.alink ? ginInfo.alink : '83dbda6bdc05877ec89c4fc8673036dd'; },
