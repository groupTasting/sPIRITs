...
var corsProxies = [
 ...
 "https://cors-anywhere.herokuapp.com/",    // 200 in 60 min
 // "https://thingproxy.freeboard.io/fetch/", // ??
 // "http://www.whateverorigin.org/get?url=", // https needed
 // "http://alloworigin.com/get?url=",
 // "https://api.allorigins.win/get?url=",   // goes into contents:
 // "https://yacdn.org/proxy/"  // <uri>?maxAge=10
...
var vueGin = new Vue({
  ...
  methods: { 
     ...
     checkTaste: function () {
       ...
       var url = 'http://kf.kobotoolbox.org/assets/akX5hMZpLEEcQa77RCNabg/submissions.json'
       var query = '{"probe":"'+this.ginId+'","uid":"'+this.uid+'"}';
       var koboUrl = proxy + url + '?query='+query;
       axios
         .get(encodeURI(koboUrl))
         .then(response => { 
	    this.updateTaste(response.data.contents);	
       });
     },
